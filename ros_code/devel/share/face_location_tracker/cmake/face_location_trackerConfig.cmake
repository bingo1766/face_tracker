...
if("TRUE" STREQUAL "TRUE")
  set(face_location_tracker_SOURCE_PREFIX /home/bingo/face_tracker/ros_code/src/face_location_tracker)
  set(face_location_tracker_DEVEL_PREFIX /home/bingo/face_tracker/ros_code/devel)
  ...
  set(face_location_tracker_INSTALL_PREFIX /home/bingo/face_tracker/ros_code/install)
...
if(NOT "/home/bingo/face_tracker/ros_code/devel/include " STREQUAL " ")
  set(face_location_tracker_INCLUDE_DIRS "")
  set(_include_dirs "/home/bingo/face_tracker/ros_code/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'face_location_tracker' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bingo/face_tracker/ros_code/src/face_location_tracker/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT face_location_tracker_NUM_DUMMY_TARGETS)
      set(face_location_tracker_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::face_location_tracker::wrapped-linker-option${face_location_tracker_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR face_location_tracker_NUM_DUMMY_TARGETS "${face_location_tracker_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::face_location_tracker::wrapped-linker-option${face_location_tracker_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND face_location_tracker_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/bingo/face_tracker/ros_code/devel/lib;/opt/ros/kinetic/lib)
