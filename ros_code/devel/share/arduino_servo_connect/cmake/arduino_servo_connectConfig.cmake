...
if("TRUE" STREQUAL "TRUE")
  set(arduino_servo_connect_SOURCE_PREFIX /home/bingo/face_tracker/ros_code/src/arduino_servo_connect)
  set(arduino_servo_connect_DEVEL_PREFIX /home/bingo/face_tracker/ros_code/devel)
  ...
  set(arduino_servo_connect_INSTALL_PREFIX /home/bingo/face_tracker/ros_code/install)
...
if(NOT "/home/bingo/face_tracker/ros_code/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'arduino_servo_connect' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bingo/face_tracker/ros_code/src/arduino_servo_connect/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT arduino_servo_connect_NUM_DUMMY_TARGETS)
      set(arduino_servo_connect_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::arduino_servo_connect::wrapped-linker-option${arduino_servo_connect_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR arduino_servo_connect_NUM_DUMMY_TARGETS "${arduino_servo_connect_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::arduino_servo_connect::wrapped-linker-option${arduino_servo_connect_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND arduino_servo_connect_LIBRARIES "${interface_target_name}")
