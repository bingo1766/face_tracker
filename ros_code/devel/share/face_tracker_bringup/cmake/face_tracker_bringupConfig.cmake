...
if("TRUE" STREQUAL "TRUE")
  set(face_tracker_bringup_SOURCE_PREFIX /home/bingo/face_tracker/ros_code/src/face_tracker_bringup)
  set(face_tracker_bringup_DEVEL_PREFIX /home/bingo/face_tracker/ros_code/devel)
  ...
  set(face_tracker_bringup_INSTALL_PREFIX /home/bingo/face_tracker/ros_code/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'face_tracker_bringup' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bingo/face_tracker/ros_code/src/face_tracker_bringup/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT face_tracker_bringup_NUM_DUMMY_TARGETS)
      set(face_tracker_bringup_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::face_tracker_bringup::wrapped-linker-option${face_tracker_bringup_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR face_tracker_bringup_NUM_DUMMY_TARGETS "${face_tracker_bringup_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::face_tracker_bringup::wrapped-linker-option${face_tracker_bringup_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND face_tracker_bringup_LIBRARIES "${interface_target_name}")
